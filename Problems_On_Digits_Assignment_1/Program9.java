/*                                                        
    Function_Name :   differenceOfEvenAndOdd()                      
...
class ProblemsOnDigits
{
    ...
    public int differenceOfEvenAndOdd() 
    {
        int iTemp = 0;
        int iEvenCnt = 0;
        int iOddCnt = 0;
...
class Program9
{
    public static void main(String A[])
    {
        ...
        iRet = pobj.differenceOfEvenAndOdd();
        
        System.out.println(" difference between even number and odd number in " + iValue + " is : " + iRet);
